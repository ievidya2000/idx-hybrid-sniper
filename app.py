...
# ===================================================================
    ...
    with st.expander("ℹ️ How to Use Market Screener"):
        ...
        **Steps:**
        ...
        4. Use filter dropdown to filter by signal type (Setup/Confirmed/Momentum/Strong RS)
        5. **Use Signal Details Inspector dropdown** to select specific stock for in-depth analysis
        6. View comprehensive filter analysis, weekly trend info, and position sizing for selected stock
        7. Click ticker name to open full chart in Chart Analysis tab
        ...
        **Tip:** SMC Confirmed signals are ready to execute NOW. SMC Setup signals need rejection confirmation first.
        ''')
    ...
    with st.expander("ℹ️ How to Use Trading Journal"):
        ...
        **Best Practices:**
        ...
        - ✅ Set proper stop loss from signal
        - ✅ Review statistics weekly
        - ❌ Don't skip losing trades
        - ❌ Don't edit historical trades
        ''')
